...
<form id="form" action="#" enctype="multipart/form-data" method="POST">
    <table class="grid">
        <tr>
            <td colspan="5"></td>
            <td><input type="button" onclick="mage.changeAction('<?php echo $this->getUrl()->getUrl('updateMedia'); ?>').setForm()" name="update" value="update"></td>
            <td><input type="button" onclick="mage.changeAction('<?php echo $this->getUrl()->getUrl('removeImage'); ?>').setForm()" name="remove" value="Remove"></td>
        </tr>
        <tr class="gridtr">
    ...
    <input type="button" name="image" onclick="mage.changeAction('<?php echo $this->getUrl()->getUrl('addImage'); ?>').setImage()" value="Upload">
</form>